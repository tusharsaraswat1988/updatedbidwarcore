...
export function createLedPurseBoosterOverlay(target, boosterAmount, teams, options) {
    return {
...
export function replayLedPurseBoosterOverlay(existing) {
    return {
        ...existing,
...
export function parseLedPurseBoosterOverlay(raw, options) {
    if (!raw)
        return null;
    try {
