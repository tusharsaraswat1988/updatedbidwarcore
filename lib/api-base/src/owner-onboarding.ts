/**
 * Shared Team Owner onboarding helpers (mobile → tournament → access code).
 * Used by owner-app and mobile-app so lookup/deep-link behaviour stays identical.
 */

import { ownerDashboardAppPath } from "./owner-urls";
...
/** Canonical sessionStorage key — shared across owner-app and mobile-app (same origin). */
