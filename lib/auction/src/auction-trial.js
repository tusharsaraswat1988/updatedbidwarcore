...
export const TRIAL_AUCTION_PARTICIPATION_ERROR = "Trial mode: only the first 2 teams can bid or receive players in the auction. Contact admin to activate your license for a full auction.";
/** Live licence unlocks full auction participation. */
export function isAuctionLicenseActive(licenseStatus) {
 ...
 */
export function isTeamEligibleForTrialAuction(teamId, options) {
    if (isAuctionLicenseActive(options.licenseStatus))
        return true;
