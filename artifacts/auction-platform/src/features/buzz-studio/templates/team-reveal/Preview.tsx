...
const SCENARIOS: { label: string; data: TeamRevealContract }[] = [
  { label: "Case 1 — Full data (Cricket)",      data: demoFullCricket       },
  { label: "Case 2 — No team logo",             data: demoNoLogo             },
  { label: "Case 3 — No captain (Kabaddi)",     data: demoNoCaptain          },
  { label: "Case 4 — High budget (₹5.2Cr)",    data: demoCricketHighBudget   },
  { label: "Case 5 — Badminton franchise",      data: demoBadminton          },
  { label: "Case 6 — Football, no spend",       data: demoFootballNoSpend    },
];

/* ─── Preview component ──────────────────────────────────────────────────── */

export function TeamRevealPreview() {
  ...
  return (
    <div style={ps.shell}>
      <header style={ps.header}>
        <h2 style={ps.heading}>Team Reveal — Dev Preview</h2>
