...
export const SIDE_LED_LAYOUT = {
  headerLogoTop: 12,
  headerLogoMaxHeight: 100,
  headerLogoMaxWidth: 440,
  tournamentNameTop: 136,
  tournamentNameSize: 84,
  tournamentNameMaxWidth: 960,
  dividerTop: 285,
  dividerHeight: 2,
  /** Sponsor spotlight — vertically centered for portrait LED totems / P1/P2/P3 screens */
  sponsorKickerTop: 590,
  sponsorKickerOffset: 0,
  sponsorKickerSize: 52,
  sponsorLogoTop: 680,
  sponsorLogoWidth: 760,
  sponsorLogoMaxHeight: 540,
  sponsorNameTop: 1270,
  sponsorNameGap: 60,
  sponsorNameSize: 115,
  sponsorCategoryTop: 1425,
  sponsorCategorySize: 48,
  sponsorFooterTop: 1840,
  sponsorFooterSize: 34,
  /** Player profile — compact header so portrait can own ~55–60% of the stack */
  profileHeaderHeight: 200,
  profileLogoTop: 6,
  profileLogoMaxHeight: 56,
  profileLogoMaxWidth: 320,
  profileTitleTopWithLogo: 96,
  profileTitleTopNoLogo: 16,
  profileTitleSize: 52,
