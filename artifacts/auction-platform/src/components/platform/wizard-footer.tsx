...
import { hubPanelClass } from "@/components/platform/platform-surface";
import {
...
/**
 * WizardFooter
 * Auction: none identical (Soft — TMC progressive steps may consume)
 * Badminton: BadmintonSetupWizardFooter (setup-wizard-footer.tsx)
 */
export function WizardFooter({
  ...
  const nextHref = continueHref ?? (following ? following.href(tournamentId) : undefined);
...
/** Compatibility alias — Badminton import name */
export const BadmintonSetupWizardFooter = WizardFooter;
