...
{{#tournament_name}}
<tr>
<td style="padding:12px 18px;border-bottom:1px solid #E8E8E8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;color:#777777;width:44%;">Tournament Name</td>
...
<td style="padding:12px 18px;border-bottom:1px solid #E8E8E8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;font-weight:700;color:#111111;">{{team_name}}</td>
</tr>
{{/team_name}}
{{#owner_name}}
<tr>
<td style="padding:12px 18px;border-bottom:1px solid #E8E8E8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;color:#777777;">Team Owner Name</td>
<td style="padding:12px 18px;border-bottom:1px solid #E8E8E8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;font-weight:600;color:#111111;">{{owner_name}}</td>
</tr>
{{/owner_name}}
{{#owner_mobile}}
<tr>
...
<td style="padding:12px 18px;border-bottom:1px solid #E8E8E8;font-family:Menlo,Consolas,monospace;font-size:15px;font-weight:700;color:#F4B400;">{{access_code}}</td>
</tr>
{{/access_code}}
{{#auction_date}}
<tr>
<td style="padding:12px 18px;border-bottom:1px solid #E8E8E8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;color:#777777;">Auction Date &amp; Time</td>
...
{{#organiser_phone}}
<tr>
<td style="padding:12px 18px;border-bottom:1px solid #E8E8E8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;color:#777777;">Organiser Contact (Software/Support)</td>
<td style="padding:12px 18px;border-bottom:1px solid #E8E8E8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;font-weight:700;color:#111111;">
{{organiser_phone}}
<span style="display:block;font-size:11px;font-weight:normal;color:#666666;margin-top:2px;">Call for tournament or software related issues</span>
</td>
</tr>
{{/organiser_phone}}
{{#organiser_email}}
...
<a href="{{login_link}}" target="_blank" style="display:inline-block;padding:14px 32px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;font-weight:700;color:#111111;text-decoration:none;border-radius:8px;">Open Owner Panel</a>
</td>
</tr>
</table>
<p style="margin:12px 0 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:12px;color:#777777;text-align:center;">
Direct link to your Owner Panel: <a href="{{login_link}}" target="_blank" style="color:#2563eb;word-break:break-all;">{{login_link}}</a>
</p>
</td>
</tr>
...
<span style="color:#F4B400;font-weight:700;margin-right:8px;">&#9679;</span><strong style="color:#111111;">Owner Panel Access:</strong> Open the owner panel link above to view your squad, purse allocation, and bidding controls.
</td>
</tr>
<tr>
<td style="padding:0 0 10px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;line-height:1.65;color:#444444;">
<span style="color:#F4B400;font-weight:700;margin-right:8px;">&#9679;</span><strong style="color:#111111;">Auction Day Login:</strong> Log in using your registered mobile number: <strong style="color:#111111;">{{owner_mobile}}</strong>.
</td>
</tr>
<tr>
<td style="padding:0 0 10px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;line-height:1.65;color:#444444;">
...
<p style="margin:0 0 10px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:18px;line-height:1.3;font-weight:700;color:#111111;">&#10084;&#65039; Support BidWar &mdash; Recommend to Other Tournaments</p>
<p style="margin:0 0 20px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;line-height:1.65;color:#444444;text-align:center;">We&apos;re building India&apos;s smartest sports tournament and auction platform.<br/>If you enjoy using BidWar, please support us by recommending BidWar to other tournament organisers, sports clubs, academies, schools, colleges, and sports communities across India.</p>
<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center">
<tr>
<td align="center" style="border-radius:8px;background-color:#F4B400;">
<a href="https://bidwar.in" target="_blank" style="display:inline-block;padding:14px 32px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;font-weight:700;color:#111111;text-decoration:none;border-radius:8px;">Visit BidWar.in</a>
</td>
</tr>
</table>
</td>
...
<p style="margin:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:12px;line-height:1.65;color:#666666;">This is an automatically generated email. Please do not reply directly to this email.<br/><br/>All tournament and franchise information shown has been configured and managed by the respective tournament organiser. BidWar is the technology platform facilitating auction and tournament operations.</p>
</td>
</tr>
</table>
</td>
...
<p style="margin:0 0 4px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:14px;line-height:1.6;color:#111111;">Thank you &amp; best regards,</p>
...
<p style="margin:0 0 4px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:13px;line-height:1.5;color:#444444;">&#9993;&#65039; <a href="mailto:support@bidwar.in" style="color:#2563eb;text-decoration:none;">support@bidwar.in</a></p>
