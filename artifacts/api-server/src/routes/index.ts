...
import auctionDataManagerRouter from "./auction-data-manager";
import tournamentWorkbookRouter from "./workbook";
...
import auctionRulesPdfRouter from "./auction-rules-pdf";
...
import googleSearchConsoleRouter from "./google-search-console";
...
router.use("/tournaments/:id/auction-data", auctionDataManagerRouter);
router.use("/tournaments/:id/workbook", tournamentWorkbookRouter);
...
router.use(auctionRulesPdfRouter);
