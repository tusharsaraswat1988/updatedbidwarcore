 ...
 * Uses full names so scorers do not confuse players from initials.
 */
...
export function MatchIdentityStrip({
  ...
  return (
    <div
      className={cn(
        "shrink-0 mx-3 mb-2 rounded-xl border border-border bg-card/80 px-3 py-2.5 min-w-0 overflow-hidden",
        className,
      )}
    >
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[10px] font-bold uppercase tracking-wider text-muted-foreground mb-2">
