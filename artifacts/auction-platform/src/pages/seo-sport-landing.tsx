...
export const SPORT_CONFIGS: Record<string, SportPageConfig> = {
  ...
  "cricket-auction-software": {
    ...
    faqs: [
      ...
      { q: "Can I stream my cricket auction live on YouTube?", a: "Yes. BidWar includes a browser-source compatible transparent overlay that adds professional broadcast graphics to your stream. Add the overlay URL as a browser source in OBS, and it automatically shows the current player's photo, live bid amount, team ticker, and bid progress bar over your stream. You can broadcast your cricket auction live to YouTube, Facebook, or any browser-source capable platform with a TV production look." },
  ...
  "football-player-auction": {
    ...
    faqs: [
      ...
      { q: "Can I stream my football auction live online?", a: "Yes. BidWar includes a browser-source compatible transparent overlay for YouTube and Facebook Live. Add the overlay URL as a browser source in OBS Studio and it displays the player photo, live bid amount, team ticker, and bid bar over your stream. This is particularly useful for league events where some team owners or supporters are watching remotely. It gives your football auction a professional broadcast look without any additional production equipment." },
  ...
  "esports-auction-system": {
    ...
    bodyParagraphs: [
      ...
      "BidWar brings this auction format to any esports event. Role-based player categories (IGL, entry fragger, support, AWPer, or any custom roles your game requires), real-time bidding from team managers on their devices, a live display screen for LAN venues or online audiences, and an broadcast overlay for Twitch and YouTube streams. It runs entirely in a browser — no LAN configuration, no firewall exceptions, no software installation on gaming rigs.",
    ],
    ...
    comparison: [
      ...
      { point: "Stream integration", manual: "No stream graphics for draft picks", bidwar: "Broadcast Overlay for Twitch/YouTube broadcasts" },
    ...
    targetAudience: [
      ...
      { title: "Valorant & CS2 LAN Event Directors", desc: "Franchise player auctions for PC esports events with full role category enforcement, LAN display screens, and broadcast overlay for stream audiences." },
  ...
  "business-league-auction": {
    ...
    bodyParagraphs: [
      ...
      "BidWar was built for exactly this kind of high-stakes, audience-facing event. Sponsor logo support on the LED broadcast display, broadcast overlay for YouTube and Facebook Live, polished owner bidding panels that work on any smartphone, and post-event analytics that double as social media content. Whether you're running a 4-department office league or a 16-company industry association championship, BidWar makes your corporate sports auction look and feel like a professional production.",
    ],
    ...
    features: [
      ...
      { icon: Radio, title: "Live Streaming Overlay for YouTube", short: "Broadcast your corporate auction to a wider audience.", long: "If your corporate event is being recorded or streamed — for remote employees, alumni watching from other cities, or a general company audience — BidWar's broadcast overlay puts professional broadcast graphics over your stream. The overlay shows the current player, live bid amount, and team ticker in real time. Stream to YouTube Live, Facebook, or any browser-source capable platform. Some companies use this for company-wide engagement events where remote offices follow along from their locations." },
    ...
    comparison: [
      ...
      { point: "Streaming capability", manual: "No integration with recording or streaming", bidwar: "Built-in Broadcast Overlay for YouTube/Facebook Live" },
  ...
  "tournament-auction-platform": {
    ...
    features: [
      ...
      { icon: Radio, title: "Broadcast Overlay", short: "Broadcast your franchise auction on YouTube, Facebook, or Twitch.", long: "Any franchise auction can be broadcast as a live event using BidWar's broadcast overlay. Add the overlay URL as a browser source in OBS Studio and it places professional bid graphics — player profile, live bid counter, team ticker — directly over your video stream. This works for all sports and all auction formats on BidWar. Cricket leagues stream to Facebook Live. Esports auctions stream to YouTube or Twitch. Corporate events stream to internal company channels." },
