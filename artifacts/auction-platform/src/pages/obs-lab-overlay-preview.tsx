...
import {
  ...
  broadcastOverlayLabPath,
} from "@/lib/broadcast-overlay";

type FacingMode = "user" | "environment";

/**
 * Camera + OBS Lab Overlay preview — same stack as lab Browser Source:
 * 1920×1080 stage → camera layer → transparent lab overlay on top.
 */
export default function ObsLabOverlayPreview() {
  const [, params] = useRoute("/tournament/:id/obs/lab/preview");
  ...
  const overlaySrc = broadcastOverlayLabPath(tournamentId);
  ...
  useEffect(() => {
    document.title = "OBS Lab Preview — BidWar";
