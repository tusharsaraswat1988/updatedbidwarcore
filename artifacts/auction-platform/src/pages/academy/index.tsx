...
export default function AcademyIndexPage() {
  ...
  const moreFeatured = (data?.featuredLessons ?? lessons)
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 space-y-14">
        ...
        <DeferredMount minHeight="12rem">
          {!loading && !isFiltering && latest.length > 0 && (
            <section>
              <h2 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4">Latest Tutorials</h2>
        ...
        <DeferredMount minHeight="16rem">
          <section>
            <h2 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4">
              {isFiltering ? `Results (${filtered.length})` : "All Tutorials"}
            </h2>
            {loading ? (
