...
export const CricketRuntimeAdapter: RuntimeAdapter<CricketPlatformDefaultsDto> = {
  sportId: "cricket",
  translate(snapshot: ResolvedRuleSnapshot): RuntimeAdapterResult<CricketPlatformDefaultsDto> {
    if (snapshot.runtimeBinding.runtimeBindingType !== "cricket_platform_defaults") {
      return {
        ok: false,
    ...
    return {
      ...
      dto: {
        ...
        playingSquadSize: num(snapshot, "cricket.match.playing_squad_size", 11),
        ...
        freeHitEnabled: bool(snapshot, "cricket.bowling.free_hit_enabled", true),
        ...
        superOverEnabled: bool(snapshot, "cricket.tie_break.super_over_enabled", true),
      },
    };
  },
};
