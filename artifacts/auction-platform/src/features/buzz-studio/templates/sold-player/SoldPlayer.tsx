  ...
  return (
    <BidwarCanvas showWatermark showFooterBranding>
      <div style={s.layout}>
        ...
        {/* ── Sold accent line — thin red strip reinforcing the SOLD state ── */}
        <div style={s.soldAccent} aria-hidden="true" />

        {/* ── Player avatar: large, monogram fallback via PlayerSlot ────────── */}
...
const s: Record<string, React.CSSProperties> = {
  ...
  /* Thin red accent line — 2px, full bleed, fades at edges */
  soldAccent: {
    width: "100%",
    height: "2px",
    background: `linear-gradient(90deg, transparent, ${t.danger}60, ${t.danger}80, ${t.danger}60, transparent)`,
    marginBottom: "20px",
    borderRadius: "1px",
  },
  ...
  /* Hero price block — wider, stronger gold border, spotlight background */
  priceBlock: {
    width: "100%",
    background: `linear-gradient(160deg, #1f1800 0%, #0d0d0d 100%)`,
    border: `1px solid ${t.primaryGold}45`,
    borderRadius: "12px",
    padding: "16px 20px",
    boxShadow: `0 0 24px ${t.primaryGold}12`,
    marginBottom: "20px",
  },
